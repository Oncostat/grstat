...
These functions rely on labels to show the correct header in the flextable. This means that functions such as `head()` or sometimes `filter()` can cause issues as they remove the labels. 

If you want to use these functions, make sure to re-assign the labels to the resulting data frame.
