...
recist = db$recist %>%
  select(subjid,rcresp,rcdt,rctlsum) %>%
  filter(subjid<3)
...
```{r}
tbl = aggregate_recist_rates(recist, subjid="subjid", rc_resp="rcresp", rc_date="rcdt", rc_sum = "rctlsum")
tbl

#If we want an ORR confirmed : 
tbl2 = aggregate_recist_rates(recist, subjid="subjid", rc_resp="rcresp", rc_date="rcdt", rc_sum = "rctlsum", confirmed = TRUE)
tbl2

#If we want the CBR :
tbl3 = aggregate_recist_rates(recist, subjid="subjid", rc_resp="rcresp", rc_date="rcdt", rc_sum = "rctlsum", confirmed = TRUE, show_CBR = TRUE)
tbl3
```
