...
unconfirmed_Best_Response_during_treatment =  unconfirmed_Best_Response_during_treatment %>%
  ...
  footnote( i = c(7), j = 1,
            value = as_paragraph(
              c("CBR was defined as the presence of at least a partial response (PR), complete response (CR), or stable disease (SD) lasting for at least the 4 next consecutive visits.")),
