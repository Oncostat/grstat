...
## Note that the end date corresponds to the latest of the following date: date of death,
## last visit, last recist scan, last news, end of treatment, or last follow-up.
head(data_surv)
