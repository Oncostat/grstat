...
globals = c(
  ...
  "first_cr", "first_date", "first_pd", "first_sum", "global_resp",
  "global_resp_check", "global_resp_num", "grade_", "h1", "h2",
  "label", "level", "min_sum", "n_ae", "n_arm", "n_severe", "n_sites",
  "n_subjid", "name", "new_lesion", "new_lesions", "non_measurable_lesion",
  "non_measurable_node", "nontarget_resp", "nontarget_resp_num",
  "nontarget_yn", "pct_ae", "pct_severe", "post_pd", "rate", "rc_date",
  ...
  "target_sum_real", "Tot", "value", "variable", "weight", "x"
)
# dput(sort(globals))
