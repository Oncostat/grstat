...
globals = c(
  ...
  "arm", "arm_", "baseline", "baseline_rc_date", "before_pd", "calc",
  "code", "col_keys", "currently", "data", "date_dlt_end", "date_dlt_start",
  "date_inclusion", "decision", "decision_label", "diff_abs_nad",
  ...
  "n_severe", "n_sites", "n_subjid", "name", "new_lesion", "new_lesions",
  "non_measurable_lesion", "non_measurable_node", "nontarget_resp",
  "nontarget_resp_num", "nontarget_yn", "pct_ae", "pct_severe",
  "post_pd", "rate", "rc_date", "rcdt", "rcnew", "rcntlresp", "rcntlyn",
  "rcresp", "rctlresp", "rctlsum", "rcvisit", "real_target_sum_min",
  "remaining_lesion", "remaining_node", "resp", "resp_num", "resp2",
  "response_num", "response_value", "rows", "sae", "severe_", "soc_",
  "soc_weight", "subj_delai", "subjid", "subjid_", "sum_bl", "sum_nadir",
  "target_diam", "target_diam_sum", "target_is_node", "target_method",
  "target_resp", "target_resp_num", "target_site", "target_sum",
  "target_sum_bl", "target_sum_bl_real", "target_sum_min", "target_sum_real",
  "Tot", "value", "variable", "weight", "x"
)
