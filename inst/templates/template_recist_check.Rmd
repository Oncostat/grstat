...
These checks signal errors that should be corrected. 
If the error comes from the CRF, the real value should be entered; if the error comes from the medical record, fill a deviation form.
